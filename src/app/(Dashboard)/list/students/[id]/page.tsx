        ...
        <div className='w-full xl:w-1/3 flex flex-col gap-4'>
            <div className='bg-white p-4 rounded-md'>
                ...
                <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
                    <Link className='p-3 rounded-md bg-custColorLight' href=''>Student&apos;s Classes</Link>
                    <Link className='p-3 rounded-md bg-custPurpleLight' href={`/list/teachers?classId=${2}`}>Student&apos;s Teachers</Link>
                    <Link className='p-3 rounded-md bg-custYellowLight' href=''>Student&apos;s Lessons</Link>
                    <Link className='p-3 rounded-md bg-pink-50' href=''>Student&apos;s Exams</Link>
                    <Link className='p-3 rounded-md bg-custColorLight' href=''>Student&apos;s 
                    Results</Link>
                </div>
            </div>
            <Performance/>
